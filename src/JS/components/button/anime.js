...
(function (e, r) {
    ...
    function O(a, c) {
        ...
        else f = (f = y(b)) ? b.substr(0, b.length - f.length) : b,
    ...
    function q(a) {
        ...
        function b(a) {
            for (var b = 0, c = {}, d = g.animations, f = d.length; b < f;) {
                ...
                if (l = h.length) for (m = h[0], w = 0; w < l; w++) p = h[w + 1],
                    t = n[w],
        ...
        function k(a) {
            ...
            if (q >= w || !k) g.began || (g.began = !0, f("begin")),
                f("run");
            if (q > n && q < k) b(q);
            else
                if (q <= n && 0 !== r && (b(0), x && e()), q >= k && r !== k || !k) b(k),
                    x || e();
            f("update");
    ...
    var ga = {
        ...
        ia = function () {
            ...
            function c(c) {
                var b = v.length;
                if (b) {
                    for (var d = 0; d < b;) v[d] && v[d].tick(c),
                        d++;
                    a()
                } else cancelAnimationFrame(B),
                    B = 0
            }
            return a
        }();
